...
- application semantic version: `0.6.1`;
- Windows executable version: `0.6.1.0`;
- release tag: `v0.6.1`.
...
2. Create and push the matching tag, for example `git tag -a v0.6.1 -m "School CSM Control Center 0.6.1"` followed by `git push origin v0.6.1`.
