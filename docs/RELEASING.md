...
- application semantic version: `0.4.0`;
- Windows executable version: `0.4.0.0`;
- release tag: `v0.4.0`.
...
2. Create and push the matching tag, for example `git tag -a v0.4.0 -m "School CSM Control Center 0.4.0"` followed by `git push origin v0.4.0`.
